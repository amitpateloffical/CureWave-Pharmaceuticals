          ...
          <div className="row g-5">
            <div className=" col-lg-3 wow fadeIn " data-wow-delay="0.1s">
              <a href="index.html" className="d-inline-block mb-3">
                ...
                CureWave Pharmaceuticals
                </h3>
              </a>
              <p className="mb-0 style={{ fontSize: '14px' }}> pb-2">
...
<a href="" className="py-2">info@CurewavePharmaceuticals.in</a>
        ...
        <div className="container wow fadeIn" data-wow-delay="0.1s">
          <div className="copyright">
            <div className="row">
              <div className="col-md-5 text-center text-md-start mb-2 mb-md-0">
                &copy; CureWave Pharmaceuticals, All Right Reserved.
              </div>
